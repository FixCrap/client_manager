	...
	return (
		<div className='h-screen w-full rounded-md bg-neutral-950 relative items-center  flex justify-center antialiased'>
			<div className='max-w-3xl mx-auto p-4 flex-col absolute top-36 items-center'>
				...
				<button className='relative md:mt-32 md:mx-auto md:ml-60  cursor-pointer   inline-flex h-12 w-32 mt-16 ml-24  md:h-16 md:w-40 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50  '>
